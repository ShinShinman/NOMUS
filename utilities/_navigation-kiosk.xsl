...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="navigation-kiosk">
		...
		<nav class="kiosk-navigation">
			<ul class="inline-list">
				...
				<xsl:apply-templates select="//kiosk-navigation/page/item[@lang = //current-language/@handle]" />
				<li><a href="{$root}/{//current-language/@handle}/{//plh-page/page/item[@lang = //current-language/@handle]/@handle}/{$search-page}/" class="icon">s</a></li>
			</ul>
		</nav>
	</xsl:template>
